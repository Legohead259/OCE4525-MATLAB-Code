...
% @param z:     the desired water depth for information [m]
% @param g:     gravitation acceleration [m/s/s] (Default: 9.81)
% @param rho:   fluid density [kg/m^3] (Default: 1025)
%
% @note: When param z is not supplied, the outputs will be an array of
% ten values evenly spaced from 0 to -h. This reflects the different
% particle trajectories and forces and pressures through the water column.
%
