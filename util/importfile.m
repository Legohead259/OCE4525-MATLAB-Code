function h2013 = importfile(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as a matrix.
%   H2013 = IMPORTFILE(FILENAME)
%   Reads data from text file FILENAME for the default selection.
%
%   H2013 = IMPORTFILE(FILENAME, STARTROW, ENDROW)
%   Reads data from rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   h2013 = importfile('41009h2013.txt', 3, 17503);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2021/11/23 11:26:03
...
h2013 = table(dataArray{1:end-1}, 'VariableNames', {'YY','MM','DD','hh','mm','WDI','RWSP','DGST','WVHT','DPD','APD','MWD','PRES','ATMP','WTMP','DEWP','VIS','TIDE'});
