function data = import_old_ndbc_data(filename, startRow, endRow)
%IMPORTFILE1 Import numeric data from a text file as a matrix.
%   H1999 = IMPORTFILE1(FILENAME)
%   Reads data from text file FILENAME for the default selection.
%
%   H1999 = IMPORTFILE1(FILENAME, STARTROW, ENDROW)
%   Reads data from rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   h1999 = importfile1('41009h1999.txt', 2, 14593);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2021/11/23 11:54:15
...
%   column1: datetimes (%{uuuu MM dd HH}D)
%	column2: double (%f)
%   column3: double (%f)
%	column4: double (%f)
%   column5: double (%f)
...
formatSpec = '%13{uuuu MM dd HH}D%4f%5f%5f%6f%6f%6f%4f%7f%6f%6f%6f%f%[^\n\r]';
...
data = table(dataArray{1:end-1}, 'VariableNames', {'Time','WD','WSP','DGST','WVHT','DPD','APD','MWD','BAR','ATMP','WTMP','DEWP','VIS'});
...
% h1999.YYYYMMDDHh=datenum(h1999.YYYYMMDDHh);
