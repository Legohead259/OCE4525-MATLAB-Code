function data = import_ndbc_data(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as a matrix.
%   H2007 = IMPORTFILE(FILENAME)
%   Reads data from text file FILENAME for the default selection.
%
%   H2007 = IMPORTFILE(FILENAME, STARTROW, ENDROW)
%   Reads data from rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   h2007 = importfile('41009h2007.txt', 3, 17413);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2021/11/18 13:41:00
...
%   column1: datetimes (%{uu MM dd HH mm}D)
%	column2: double (%f)
%   column3: double (%f)
%	column4: double (%f)
%   column5: double (%f)
...
formatSpec = '%16{uu MM dd HH mm}D%4f%5f%5f%6f%6f%6f%4f%7f%6f%6f%6f%5f%f%[^\n\r]';
...
data = table(dataArray{1:end-1}, 'VariableNames', {'YYMMDDHhMm','WDI','RWSP','DGST','WVHT','DPD','APD','MWD','PRES','ATMP','WTMP','DEWP','VIS','TIDE'});
...
% h2007.YYMMDDHhMm=datenum(h2007.YYMMDDHhMm);
