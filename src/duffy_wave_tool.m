...
% User Parameters
d1 = 10;        % Depth at position 1 - m
H1 = 2;         % Wave height at d_1 - m
theta1 = 20;    % Wave angle at d_1 - deg rel to shore
T = 10;         % Wave period - s
m = 1/50;       % Bottom slope
...
[L1, C1, n1, Cg1, ~, Ks1] = wave_params(H1, T, d1); % Calculate the wave parameters at d_1
